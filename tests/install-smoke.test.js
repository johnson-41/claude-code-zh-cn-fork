...
test("install smoke skips unverified native binaries instead of pretending CLI Patch succeeded", { skip: unixShellRequired }, () => {
  ...
  assert.match(output, /2\.1\.113 - 2\.1\.156/, "the message should show the verified native window");
  assert.match(output, /不含/, "the message should mention excluded versions");
