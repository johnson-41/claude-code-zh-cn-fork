#!/usr/bin/env bash
# Remote bootstrap uninstaller for claude-code-zh-cn-fork.
# Intended usage after being attached to the latest GitHub Release:
#   curl -fsSL https://github.com/Lijianpeng-Arch/claude-code-zh-cn-fork/releases/latest/download/uninstall-remote.sh | bash
